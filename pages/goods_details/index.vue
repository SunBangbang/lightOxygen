			...
			<view>
				<scroll-view :scroll-top="scrollTop" scroll-y="true" scroll-with-animation="true"
                    ...
                    " src="../../static/images/svip.gif"></image>
								...
								<!-- <view style="display:flex;margin-left:10rpx;" v-if="storeInfo.gouwunums>0">{{storeInfo.gouwunums}}</view> -->
								<view style="display:flex;margin-left:10rpx;" class="activity22"  v-if="storeInfo.gouwunums>0">
									<view class="left"></view>
										<view class="box-num">赠送{{storeInfo.gouwunums}}艾叶</view>
                ...
                " class="svip acea-row row-between-wrapper">
							...
							<!-- <view class='coupon acea-row row-between-wrapper' v-if="storeInfo.give_integral > 0">
									<view class='hide line1 acea-row'>
										赠产品券：
										<view class='activity'>赠送 {{storeInfo.give_integral}} 产品券</view>
									</view>
								</view> -->
...
<style scoped lang="scss">
	...
	.activity22{
		...
		position: relative;
		margin: 9px 0 0 7px;
		background: linear-gradient(90deg, rgba(250,127,48, 1) 0%, rgba(255, 187, 86, 1) 100%);
		border-radius:10rpx;
		color:#ffffff;
		font-size:26rpx;
		display:flex;
