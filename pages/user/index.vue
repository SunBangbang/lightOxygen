					...
					<view class="user-card" :class="member_style==3?'unBg':''">
						...
						<view class="num-wrapper">
							<!-- <view class="num-item"
								...
								<view class="num-item"
									@click="goMenuPage('/pages/money/gold')">
								<text class="num">{{userInfo.now_money || 0}}</text>
								<view class="txt">金积分</view>
							</view>
							...
							<view class="num-item" @click="goMenuPage('/pages/money/silver')">
							<!-- <view class="num-item" @click="goMenuPage('/pages/users/user_coupon/index')"> -->
								<text class="num">{{userInfo.couponCount || 0}}</text>
								<view class="txt">银积分</view>
							</view>
							<!-- <view class="num-item" @click="goMenuPage('/pages/users/user_integral/index')"> -->
							<view class="num-item" @click="goMenuPage('/pages/money/silver')">
								<text class="num">{{userInfo.integral || 0}}</text>
								<view class="txt">氢积分</view>
							</view>
						</view>
						<!-- <view class="num-wrapper">
	...
	.new-users {
		...
		.head {
			...
			.user-card {
				...
				// background-image: linear-gradient(to right, #3981a5 , #ffffff);
				.user-info {
					z-index: 20;
					position: relative;
					display: flex;
