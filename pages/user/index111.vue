					...
					<view class="user-card" :class="member_style==3?'unBg':''">
						...
						<view class="user-info">
							...
							<view class="info">
								...
								<view style="display: flex;align-items: center;">
									...
									<view class="leixing" v-if="userInfo.group_id===1 && userInfo.group_id>0">生活馆</view>
									<view class="leixing" v-if="userInfo.group_id===2 && userInfo.group_id>0">专卖店</view>
									<view class="leixing" v-if="userInfo.group_id===3 && userInfo.group_id>0">旗舰店</view>
								</view>
							...
							<view class="message">
								<navigator url="/pages/users/message_center/index" hover-class="none">
									...
									<image src="../../static/images/xiaoxi_icon.png" class="xiaoxi_icon"></image>
								</navigator>
							</view>
							<!-- #ifdef MP -->
						...
						<view class="num-wrapper">
							...
							<view class="num-item" @click="goMenuPage('/pages/users/user_coupon/index')">
								...
								<view class="txt">银艾叶</view>
							</view>
							<view class="num-item" @click="goMenuPage('/pages/users/user_integral/index')">
								<text class="num">{{userInfo.integral || 0}}</text>
								<view class="txt">产品券</view>
							</view>
						</view>
	...
	export default {
		...
		data() {
			return {
				...
				selectIndex: 4,
				orderMenuLists:[{
						img: '../../static/images/dfk_icon.png',
						title: '待付款',
						url: '/pages/users/order_list/index?status=0'
					},
					{
						img: '../../static/images/dfh_icon.png',
						title: '待发货',
						url: '/pages/users/order_list/index?status=1'
					},
					{
						img: '../../static/images/dsk_icon.png',
						title: '待收货',
						url: '/pages/users/order_list/index?status=2'
					},
					{
						img: '../../static/images/dpj_icon.png',
						title: '待评价',
						url: '/pages/users/order_list/index?status=3'
					},
					{
						img: '../../static/images/sh_icon.png',
						title: '售后/退款',
				...
				storeMenu1:[
					{
						img: '../../static/images/cy1_icon.png',
						title: '邀请好友',
						url: '/pages/users/user_return_list/index'
					},
					{
						img: '../../static/images/cy2_icon.png',
						title: '购物券',
						url: '/pages/users/user_return_list/index'
					},
					{
						img: '../../static/images/cy3_icon.png',
						title: '产品券',
						url: '/pages/users/user_return_list/index'
					},
					{
						img: '../../static/images/cy4_icon.png',
						title: '地址信息',
						url: '/pages/users/user_return_list/index'
					},
					{
						img: '../../static/images/cy5_icon.png',
						title: '优惠券',
						url: '/pages/users/user_return_list/index'
					},
					{
						img: '../../static/images/cy6_icon.png',
						title: '联系客服',
						url: '/pages/users/user_return_list/index'
					},
					{
						img: '../../static/images/cy7_icon.png',
						title: '我的收藏',
						url: '/pages/users/user_return_list/index'
					},
					{
						img: '../../static/images/cy8_icon.png',
						title: '客服中心',
						url: '/pages/users/user_return_list/index'
					},
				],
	...
	.new-users {
		...
		.head {
			...
			.user-card {
				...
				background: url(../../static/images/center_bg.png);
				background-size: 100% 100%;
