...
<!-- 				<image :src="logoUrl" v-if="logoUrl" />
				<image src="/static/images/dl_logo.png" v-else /> -->
			</view>
			<view class="whiteBg" v-if="formItem === 1">
				<view class="list" v-if="current !== 1">
					<form @submit.prevent="submit">
						...
						<view class="item">
							<view class="acea-row row-middle">
								<view style="width: 40rpx;"></view>
								<!-- <image src="/static/images/dl_icon2.png" style="width: 32rpx; height: 32rpx;"></image> -->
				...
				<view class="list" v-if="current !== 0 || appLoginStatus || appleLoginStatus">
					...
					<view class="item">
						<view class="acea-row row-middle">
							<view style="width: 40rpx;"></view>
							<!-- <image src="/static/images/code_img.png" style="width: 42rpx; height: 38rpx;"></image> -->
