<template>
	<view>
		<view class='integral-details' :style="colorStyle">
			<view class='header'>
				<view class='currentScore'>当前产品券</view>
			...
			<view class='wrapper'>
				...
				<view class='list' :hidden='current!=0'>
					<!-- <view class='tip acea-row row-middle' v-if="!isTime"><text
							class='iconfont icon-shuoming'></text>提示：产品券数值的高低会直接影响您的会员等级</view>
					<view class='tip acea-row row-middle' v-else><text
							class='iconfont icon-shuoming'></text>提示：你有{{userInfo.clear_integral}}产品券在{{ userInfo.clear_time | dateFormat }}过期，请尽快使用
					</view> -->
					...
					<view v-if="integralList.length == 0">
						<emptyPage title="暂无产品券记录哦～"></emptyPage>
					</view>
				</view>
				<view class='list2' :hidden='current!=1'>
					<!-- <navigator class='item acea-row row-between-wrapper' hover-class='none' open-type="switchTab"
						...
						<view class='name'>购买商品可获得产品券奖励</view>
						<view class='earn'>赚产品券</view>
					</navigator> -->
					<!-- <navigator class='item acea-row row-between-wrapper' hover-class='none'
						...
						<view class='name'>每日签到可获得产品券奖励</view>
						<view class='earn'>赚产品券</view>
					</navigator> -->
				</view>
			</view>
