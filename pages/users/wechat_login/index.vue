<template>
	...
	<view class="login-wrapper" :style="colorStyle">
		<view class="shading">
			<image src="/static/images/logo_dl.png"/>
		</view>
		<view class="whiteBg">
			<view class="list">
				<!-- <view class="item">
				...
				<view class="item">
					<view class="acea-row row-middle">
						<view style="width:40rpx">
							<!-- <image src="/static/images/mobile.png" style="width: 36rpx; height: 34rpx;"></image> -->
						</view>
				...
				<view class="item">
					<view class="acea-row row-middle">
						<view style="width:40rpx">
							<!-- <image src="/static/images/mima.png" style="width: 30rpx; height: 32rpx;"></image> -->
						</view>
